...
public class GuiVideoRenderer extends GuiScreen implements Tickable {
   ...
   private final int[] renderTimes;
   private int currentIndex;

   public GuiVideoRenderer(VideoRenderer renderer) {
      this.pauseButton = (new GuiButton(this.buttonPanel)).onClick(new Runnable() {
         public void run() {
      ...
      this.cancelButton = (new GuiButton(this.buttonPanel) {
         ...
         public boolean mouseClick(ReadablePoint position, int button) {
            ...
            if (this.waitingForConfirmation && !result) {
               this.setI18nLabel("replaymod.gui.rendering.cancel");
         ...
         public void onClick() {
            ...
            if (!this.waitingForConfirmation) {
               this.setI18nLabel("replaymod.gui.rendering.cancel.callback");
      ...
      }).addElements(null, this.title, this.imagePanel, this.previewCheckbox, this.renderTime, this.remainingTime, this.progressBar, this.buttonPanel);
   ...
   public void tick() {
      ...
      String var10001 = I18n.get("replaymod.gui.rendering.timetaken");
      var10000.setText(var10001 + ": " + this.secToString(this.renderTimeTaken / 1000));
      var10000 = this.remainingTime;
      var10001 = I18n.get("replaymod.gui.rendering.timeleft");
      ...
      this.progressBar.setI18nLabel("replaymod.gui.rendering.progress", framesRendered, renderTime);
   ...
   private String secToString(int seconds) {
      ...
      if (hours > 0) {
         builder.append(hours).append(I18n.get("replaymod.gui.hours"));
      }

      if (min > 0 || hours > 0) {
         builder.append(min).append(I18n.get("replaymod.gui.minutes"));
      }
