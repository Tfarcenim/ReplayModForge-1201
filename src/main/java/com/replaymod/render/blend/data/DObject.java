...
public class DObject {
   ...
   public static enum Type {
      ...
      private static DObject.Type[] $values() {
         return new DObject.Type[]{OB_EMPTY, OB_MESH, OB_CURVE, OB_SURF, OB_FONT, OB_MBALL, OB_6, OB_7, OB_8, OB_9, OB_LAMP, OB_CAMERA, OB_SPEAKER, OB_13, OB_14, OB_15, OB_16, OB_17, OB_18, OB_19, OB_20, OB_WAVE, OB_LATTICE, OB_23, OB_24, OB_ARMATURE};
      }
   }
}
