...
public class CubicOpenGlFrameCapturer extends OpenGlFrameCapturer<CubicOpenGlFrame, CubicOpenGlFrameCapturer.Data> {
   ...
   public Map<Channel, CubicOpenGlFrame> process() {
      ...
      CubicOpenGlFrame frame = new CubicOpenGlFrame(this.renderFrame(frameId, partialTicks, CubicOpenGlFrameCapturer.Data.LEFT), this.renderFrame(frameId, partialTicks, CubicOpenGlFrameCapturer.Data.RIGHT), this.renderFrame(frameId, partialTicks, CubicOpenGlFrameCapturer.Data.FRONT), this.renderFrame(frameId, partialTicks, CubicOpenGlFrameCapturer.Data.BACK), this.renderFrame(frameId, partialTicks, CubicOpenGlFrameCapturer.Data.TOP), this.renderFrame(frameId, partialTicks, CubicOpenGlFrameCapturer.Data.BOTTOM));
