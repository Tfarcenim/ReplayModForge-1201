...
public class RestoreReplayGui extends AbstractGuiScreen<RestoreReplayGui> {
   ...
   public RestoreReplayGui(ReplayMod core, GuiScreen parent, File file) {
      this.contentPanel = (GuiPanel)((GuiPanel)(new GuiPanel(this)).addElements(new VerticalLayout.Data(0.5D), new GuiElement[]{this.textPanel, this.buttonPanel})).setLayout((new VerticalLayout()).setSpacing(20));
      this.yesButton = (GuiButton)((GuiButton)(new GuiButton(this.buttonPanel)).setSize(150, 20)).setI18nLabel("gui.yes", new Object[0]);
      this.noButton = (GuiButton)((GuiButton)(new GuiButton(this.buttonPanel)).setSize(150, 20)).setI18nLabel("gui.no", new Object[0]);
      this.core = core;
      this.parent = parent;
      this.file = file;
      this.textPanel.addElements(new VerticalLayout.Data(0.5D), new GuiElement[]{(new GuiLabel()).setI18nText("replaymod.gui.restorereplay1", new Object[0]), (new GuiLabel()).setI18nText("replaymod.gui.restorereplay2", new Object[]{Files.getNameWithoutExtension(file.getName())}), (new GuiLabel()).setI18nText("replaymod.gui.restorereplay3", new Object[0])});
   ...
   private void recoverInBackground() {
      ...
      GuiPanel savingProcess = (GuiPanel)((GuiPanel)(new GuiPanel()).setLayout(new VerticalLayout())).addElements(new VerticalLayout.Data(0.5D), new GuiElement[]{label, progressBar});
      (new Thread(() -> {
         this.core.runLater(() -> {
