...
public class ReplayModReplay implements Module {
   ...
   public void registerKeyBindings(KeyBindingRegistry registry) {
      ...
      registry.registerKeyBinding("key.replaymod.thumbnail", MCVer.Keyboard.KEY_N, new Runnable() {
         @Override
         public void run() {
      ...
      this.keyPlayPause = registry.registerKeyBinding("key.replaymod.playpause", 80, new Runnable() {
         public void run() {
            if (ReplayModReplay.this.replayHandler != null) {
      ...
      this.core.getKeyBindingRegistry().registerKeyBinding("key.replaymod.rollclockwise", 76, () -> {
      }, true);
      this.core.getKeyBindingRegistry().registerKeyBinding("key.replaymod.rollcounterclockwise", 74, () -> {
      }, true);
      this.core.getKeyBindingRegistry().registerKeyBinding("key.replaymod.resettilt", 75, () -> {
