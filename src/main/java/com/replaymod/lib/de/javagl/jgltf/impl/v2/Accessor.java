...
public class Accessor extends GlTFChildOfRootProperty {
   ...
   public void setComponentType(Integer componentType) {
      ...
      } else if (componentType != 5120 && componentType != 5121 && componentType != 5122 && componentType != 5123 && componentType != 5125 && componentType != 5126) {
   ...
   public void setType(String type) {
      ...
      } else if (!"SCALAR".equals(type) && !"VEC2".equals(type) && !"VEC3".equals(type) && !"VEC4".equals(type) && !"MAT2".equals(type) && !"MAT3".equals(type) && !"MAT4".equals(type)) {
