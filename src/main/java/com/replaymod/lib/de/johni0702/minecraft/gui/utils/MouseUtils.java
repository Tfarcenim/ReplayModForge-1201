...
public class MouseUtils {
   ...
   public static Point getMousePos() {
      ...
      mouseX = (int)Math.round((double)mouseX * (double)mainWindow.getGuiScaledWidth() / (double)mainWindow.getScreenWidth());
      mouseY = (int)Math.round((double)mouseY * (double)mainWindow.getGuiScaledHeight() / (double)mainWindow.getScreenHeight());
