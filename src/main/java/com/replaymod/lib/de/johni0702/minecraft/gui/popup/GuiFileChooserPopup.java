...
public class GuiFileChooserPopup extends AbstractGuiPopup<GuiFileChooserPopup> implements Typeable {
   ...
   public static GuiFileChooserPopup openLoadGui(GuiContainer container, String buttonLabel, String... fileExtensions) {
      ...
      popup.acceptButton.setI18nLabel(buttonLabel, new Object[0]).setDisabled();
      popup.open();
      return popup;
   }
   ...
   public GuiFileChooserPopup(GuiContainer container, String[] fileExtensions, boolean load) {
      ...
      this.pathPanel = (new GuiPanel(this.pathScrollable)).setLayout(new HorizontalLayout());
      this.fileList = new GuiVerticalList(this.popup);
      this.nameField = (new GuiTextField(this.popup)).onEnter(new Runnable() {
         public void run() {
      ...
      this.acceptButton = (new GuiButton(this.popup)).onClick(new Runnable() {
         public void run() {
      ...
      this.cancelButton = (new GuiButton(this.popup)).onClick(new Runnable() {
         public void run() {
