...
public abstract class AbstractGuiElement<T extends AbstractGuiElement<T>> implements GuiElement<T> {
   ...
   public ReadableDimension getMinSize() {
      ...
      if (this.minSize == null) {
         ...
         return this.minSize.getWidth() >= calcSize.getWidth() && this.minSize.getHeight() >= calcSize.getHeight() ? this.minSize : new Dimension(Math.max(calcSize.getWidth(), this.minSize.getWidth()), Math.max(calcSize.getHeight(), this.minSize.getHeight()));
      }
   }
