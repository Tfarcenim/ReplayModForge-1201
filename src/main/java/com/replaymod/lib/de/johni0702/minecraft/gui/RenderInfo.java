...
public class RenderInfo {
   ...
   public void addTo(CrashReport crashReport) {
      ...
      MCVer.addDetail(category, "Partial Tick", () -> String.valueOf(partialTick));
      MCVer.addDetail(category, "Mouse X", () -> String.valueOf(mouseX));
      MCVer.addDetail(category, "Mouse Y", () -> String.valueOf(mouseY));
      MCVer.addDetail(category, "Layer", () -> String.valueOf(layer));
   }
   ...
   public boolean equals(Object o) {
      if (this == o) {
         ...
         return Float.compare(that.partialTick, this.partialTick) == 0 && this.mouseX == that.mouseX && this.mouseY == that.mouseY && this.layer == that.layer;
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      return Objects.hash(this.partialTick, this.mouseX, this.mouseY, this.layer);
   }
