...
public class PathPreview extends EventRegistrations {
   ...
   public void registerKeyBindings(KeyBindingRegistry registry) {
      registry.registerKeyBinding("key.replaymod.pathpreview", 72, () -> {
   ...
   private void update() {
      if ((Boolean)this.mod.getCore().getSettingsRegistry().get(Setting.PATH_PREVIEW) && this.replayHandler != null) {
